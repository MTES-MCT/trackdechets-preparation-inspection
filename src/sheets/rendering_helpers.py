...
def render_pdf_sheet_fn(computed_pk: str):
    ...
    ctx = {
        ...
        "rndts_transporter_statement_stats_graph": sheet.rndts_transporter_statement_stats_graph,
        "rndts_transporter_quantities_graph": sheet.rndts_transporter_quantities_graph,
