...
export const WASTE_CODES = [
  {
    code: "01 01 01",
    description: "déchets provenant de l'extraction des minéraux métallifères",
  },
  {
    code: "01 01 02",
    description:
  ...
  { code: "01 03 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "01 04 07*",
    description:
      "déchets contenant des substances dangereuses provenant de la transformation physique et chimique des minéraux non métallifères",
  ...
  { code: "01 04 09", description: "déchets de sable et d'argile" },
  {
    code: "01 04 10",
    description:
      "déchets de poussières et de poudres autres que ceux visés à la rubrique 01 04 07",
  ...
  { code: "01 04 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "01 05 04",
    description: "boues et autres déchets de forage à l'eau douce",
  },
  ...
  { code: "01 05 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "02 01 01",
    description: "boues provenant du lavage et du nettoyage",
  },
  { code: "02 01 02", description: "déchets de tissus animaux" },
  { code: "02 01 03", description: "déchets de tissus végétaux" },
  {
    code: "02 01 04",
    description:
      "déchets de matières plastiques (à l'exclusion des emballages)",
  ...
  {
    code: "02 01 08*",
    description: "déchets agrochimiques contenant des substances dangereuses",
  },
  {
    code: "02 01 09",
    description:
  ...
  { code: "02 01 10", description: "déchets métalliques" },
  { code: "02 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "02 02 01",
    description: "boues provenant du lavage et du nettoyage",
  },
  { code: "02 02 02", description: "déchets de tissus animaux" },
  {
    code: "02 02 03",
    description: "matières impropres à la consommation ou à la transformation",
  },
  {
    code: "02 02 04",
    description: "boues provenant du traitement in situ des effluents",
  },
  { code: "02 02 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "02 03 01",
    description:
      "boues provenant du lavage, du nettoyage, de l'épluchage, de la centrifugation et de la séparation",
  },
  { code: "02 03 02", description: "déchets d'agents de conservation" },
  {
    code: "02 03 03",
    description: "déchets de l'extraction aux solvants",
  },
  ...
  { code: "02 03 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "02 04 01",
    description: "terre provenant du lavage et du nettoyage des betteraves",
  },
  { code: "02 04 02", description: "carbonate de calcium déclassé" },
  {
    code: "02 04 03",
    description: "boues provenant du traitement in situ des effluents",
  },
  { code: "02 04 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "02 05 01",
    description: "matières impropres à la consommation ou à la transformation",
  },
  ...
  { code: "02 05 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "02 06 01",
    description: "matières impropres à la consommation ou à la transformation",
  },
  { code: "02 06 02", description: "déchets d'agents de conservation" },
  {
    code: "02 06 03",
    description: "boues provenant du traitement in situ des effluents",
  },
  { code: "02 06 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "02 07 01",
    description:
      "déchets provenant du lavage, du nettoyage et de la réduction mécanique des matières premières",
  ...
  { code: "02 07 03", description: "déchets de traitements chimiques" },
  {
    code: "02 07 04",
    description: "matières impropres à la consommation ou à la transformation",
  },
  ...
  { code: "02 07 99", description: "déchets non spécifiés ailleurs" },
  { code: "03 01 01", description: "déchets d'écorce et de liège" },
  {
    code: "03 01 04*",
    description:
      "sciure de bois, copeaux, chutes, bois, panneaux de particules et placages contenant des substances dangereuses",
  ...
  { code: "03 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "03 02 01*",
    description: "composés organiques non halogénés de protection du bois",
  },
  {
    code: "03 02 02*",
    description: "composés organochlorés de protection du bois",
  ...
  {
    code: "03 02 99",
    description: "produits de protection du bois non spécifiés ailleurs",
  },
  { code: "03 03 01", description: "déchets d'écorce et de bois" },
  {
    code: "03 03 02",
    description:
      "liqueurs vertes (provenant de la récupération de liqueur de cuisson)",
  ...
  { code: "03 03 99", description: "déchets non spécifiés ailleurs" },
  { code: "04 01 01", description: "déchets d'écharnage et refentes" },
  { code: "04 01 02", description: "résidus de pelanage" },
  {
    code: "04 01 03*",
    description:
      "déchets de dégraissage contenant des solvants sans phase liquide",
  ...
  { code: "04 01 05", description: "liqueur de tannage sans chrome" },
  {
    code: "04 01 06",
    description:
      "boues, notamment provenant du traitement in situ des effluents, contenant du chrome",
  ...
  { code: "04 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "04 02 09",
    description:
      "matériaux composites (textile imprégné, élastomère, plastomère)",
  ...
  {
    code: "04 02 16*",
    description: "teintures et pigments contenant des substances dangereuses",
  },
  {
    code: "04 02 17",
    description:
  ...
  { code: "04 02 21", description: "fibres textiles non ouvrées" },
  { code: "04 02 22", description: "fibres textiles ouvrées" },
  { code: "04 02 99", description: "déchets non spécifiés ailleurs" },
  { code: "05 01 02*", description: "boues de dessalage" },
  { code: "05 01 03*", description: "boues de fond de cuves" },
  { code: "05 01 04*", description: "boues d'alkyles acides" },
  {
    code: "05 01 05*",
    description: "hydrocarbures accidentellement répandus",
  },
  ...
  { code: "05 01 07*", description: "goudrons acides" },
  { code: "05 01 08*", description: "autres goudrons" },
  {
    code: "05 01 09*",
    description:
      "boues provenant du traitement in situ des effluents contenant des substances dangereuses",
  ...
  {
    code: "05 01 13",
    description: "boues du traitement de l'eau d'alimentation des chaudières",
  },
  {
    code: "05 01 14",
    description: "déchets provenant des colonnes de refroidissement",
  },
  { code: "05 01 15*", description: "argiles de filtration usées" },
  {
    code: "05 01 16",
    description:
      "déchets contenant du soufre provenant de la désulfuration du pétrole",
  },
  { code: "05 01 17", description: "mélanges bitumineux" },
  { code: "05 01 99", description: "déchets non spécifiés ailleurs" },
  { code: "05 06 01*", description: "goudrons acides" },
  { code: "05 06 03*", description: "autres goudrons" },
  {
    code: "05 06 04",
    description: "déchets provenant des colonnes de refroidissement",
  },
  { code: "05 06 99", description: "déchets non spécifiés ailleurs" },
  { code: "05 07 01*", description: "déchets contenant du mercure" },
  { code: "05 07 02", description: "déchets contenant du soufre" },
  { code: "05 07 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "06 01 01*",
    description: "acide sulfurique et acide sulfureux",
  },
  { code: "06 01 02*", description: "acide chlorhydrique" },
  { code: "06 01 03*", description: "acide fluorhydrique" },
  {
    code: "06 01 04*",
    description: "acide phosphorique et acide phosphoreux",
  },
  { code: "06 01 05*", description: "acide nitrique et acide nitreux" },
  { code: "06 01 06*", description: "autres acides" },
  { code: "06 01 99", description: "déchets non spécifiés ailleurs" },
  { code: "06 02 01*", description: "hydroxyde de calcium" },
  { code: "06 02 03*", description: "hydroxyde d'ammonium" },
  {
    code: "06 02 04*",
    description: "hydroxyde de sodium et hydroxyde de potassium",
  },
  { code: "06 02 05*", description: "autres bases" },
  { code: "06 02 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "06 03 11*",
    description: "sels et solutions contenant des cyanures",
  },
  ...
  { code: "06 03 99", description: "déchets non spécifiés ailleurs" },
  { code: "06 04 03*", description: "déchets contenant de l'arsenic" },
  { code: "06 04 04*", description: "déchets contenant du mercure" },
  {
    code: "06 04 05*",
    description: "déchets contenant d'autres métaux lourds",
  },
  { code: "06 04 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "06 05 02*",
    description:
      "boues provenant du traitement in situ des effluents contenant des substances dangereuses",
  ...
  { code: "06 06 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "06 07 01*",
  ...
  { code: "06 07 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "06 08 02*",
    description: "déchets contenant des chlorosilanes dangereux",
  },
  { code: "06 08 99", description: "déchets non spécifiés ailleurs" },
  { code: "06 09 02", description: "scories phosphoriques" },
  {
    code: "06 09 03*",
    description:
      "déchets de réactions basées sur le calcium contenant des substances dangereuses ou contaminées par de telles substances",
  ...
  { code: "06 09 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "06 10 02*",
    description: "déchets contenant des substances dangereuses",
  },
  { code: "06 10 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "06 11 01",
    description:
      "déchets de réactions basées sur le calcium provenant de la production de dioxyde de titane",
  },
  { code: "06 11 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "06 13 01*",
    description:
      "produits phytosanitaires inorganiques, agents de protection du bois et autres biocides",
  ...
  { code: "06 13 03", description: "noir de carbone" },
  {
    code: "06 13 04*",
    description: "déchets provenant de la transformation de l'amiante",
  },
  { code: "06 13 05*", description: "suies" },
  { code: "06 13 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "07 01 01*",
    description: "eaux de lavage et liqueurs mères aqueuses",
  },
  ...
  {
    code: "07 01 07*",
    description: "résidus de réaction et résidus de distillation halogénés",
  },
  {
    code: "07 01 08*",
    description: "autres résidus de réaction et résidus de distillation",
  },
  {
    code: "07 01 09*",
    description: "gâteaux de filtration et absorbants usés halogénés",
  ...
  { code: "07 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "07 02 01*",
    description: "eaux de lavage et liqueurs mères aqueuses",
  },
  ...
  { code: "07 02 13", description: "déchets plastiques" },
  {
    code: "07 02 14*",
    description:
      "déchets provenant d'additifs contenant des substances dangereuses",
  ...
  { code: "07 02 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "07 03 01*",
    description: "eaux de lavage et liqueurs mères aqueuses",
  },
  ...
  { code: "07 03 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "07 04 01*",
    description: "eaux de lavage et liqueurs mères aqueuses",
  },
  ...
  { code: "07 04 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "07 05 01*",
    description: "eaux de lavage et liqueurs mères aqueuses",
  },
  ...
  {
    code: "07 05 14",
    description: "déchets solides autres que ceux visés à la rubrique 07 05 13",
  },
  { code: "07 05 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "07 06 01*",
    description: "eaux de lavage et liqueurs mères aqueuses",
  },
  ...
  { code: "07 06 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "07 07 01*",
    description: "eaux de lavage et liqueurs mères aqueuses",
  },
  ...
  { code: "07 07 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "08 01 11*",
    description:
      "déchets de peintures et vernis contenant des solvants organiques ou d'autres substances dangereuses",
  ...
  { code: "08 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "08 02 01",
    description: "déchets de produits de revêtement en poudre",
  },
  ...
  {
    code: "08 02 03",
    description: "suspensions aqueuses contenant des matériaux céramiques",
  },
  { code: "08 02 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "08 03 07",
    description: "boues aqueuses contenant de l'encre",
  },
  ...
  {
    code: "08 03 12*",
    description: "déchets d'encres contenant des substances dangereuses",
  },
  {
    code: "08 03 13",
    description:
  ...
  { code: "08 03 16*", description: "déchets de solution de morsure" },
  {
    code: "08 03 17*",
    description:
      "déchets de toner d'impression contenant des substances dangereuses",
  ...
  { code: "08 03 19*", description: "huiles dispersées" },
  { code: "08 03 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "08 04 09*",
    description:
      "déchets de colles et mastics contenant des solvants organiques ou d'autres substances dangereuses",
  ...
  { code: "08 04 17*", description: "huile de résine" },
  { code: "08 04 99", description: "déchets non spécifiés ailleurs" },
  { code: "08 05 01*", description: "déchets d'isocyanates" },
  {
    code: "09 01 01*",
    description: "bains de développement aqueux contenant un activateur",
  },
  {
    code: "09 01 02*",
    description: "bains de développement aqueux pour plaques offset",
  ...
  { code: "09 01 04*", description: "bains de fixation" },
  {
    code: "09 01 05*",
    description: "bains de blanchiment et bains de blanchiment/fixation",
  },
  {
    code: "09 01 06*",
    description:
  ...
  { code: "09 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 01 01",
    description:
      "mâchefers, scories et cendres sous chaudière (sauf cendres sous chaudière visées à la rubrique 10 01 04)",
  },
  { code: "10 01 02", description: "cendres volantes de charbon" },
  {
    code: "10 01 03",
    description: "cendres volantes de tourbe et de bois non traité",
  },
  {
    code: "10 01 04*",
    description: "cendres volantes et cendres sous chaudière d'hydrocarbures",
  },
  {
    code: "10 01 05",
    description:
  ...
  { code: "10 01 09*", description: "acide sulfurique" },
  {
    code: "10 01 13*",
    description:
      "cendres volantes provenant d'hydrocarbures émulsifiés employés comme combustibles",
  ...
  {
    code: "10 01 26",
    description: "déchets provenant de l'épuration des eaux de refroidissement",
  },
  { code: "10 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 02 01",
    description: "déchets de laitiers de hauts fourneaux et d'aciéries",
  },
  { code: "10 02 02", description: "laitiers non traités" },
  {
    code: "10 02 07*",
    description:
      "déchets solides provenant de l'épuration des fumées contenant des substances dangereuses",
  ...
  { code: "10 02 10", description: "battitures de laminoir" },
  {
    code: "10 02 11*",
    description:
      "déchets provenant de l'épuration des eaux de refroidissement contenant des hydrocarbures",
  ...
  { code: "10 02 99", description: "déchets non spécifiés ailleurs" },
  { code: "10 03 02", description: "déchets d'anodes" },
  {
    code: "10 03 04*",
    description: "scories provenant de la production primaire",
  },
  { code: "10 03 05", description: "déchets d'alumine" },
  {
    code: "10 03 08*",
    description: "scories salées de seconde fusion",
  },
  ...
  {
    code: "10 03 16",
    description: "écumes autres que celles visées à la rubrique 10 03 15",
  },
  {
    code: "10 03 17*",
    description: "déchets goudronnés provenant de la fabrication des anodes",
  },
  {
    code: "10 03 18",
    description:
  ...
  { code: "10 03 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 04 01*",
    description: "scories provenant de la production primaire et secondaire",
  },
  {
    code: "10 04 02*",
    description:
  ...
  { code: "10 04 03*", description: "arséniate de calcium" },
  {
    code: "10 04 04*",
    description: "poussières de filtration des fumées",
  },
  { code: "10 04 05*", description: "autres fines et poussières" },
  {
    code: "10 04 06*",
    description: "déchets solides provenant de l'épuration des fumées",
  },
  ...
  { code: "10 04 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 05 01",
    description: "scories provenant de la production primaire et secondaire",
  },
  ...
  { code: "10 05 04", description: "autres fines et poussières" },
  {
    code: "10 05 05*",
    description: "déchets solides provenant de l'épuration des fumées",
  },
  ...
  { code: "10 05 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 06 01",
    description: "scories provenant de la production primaire et secondaire",
  },
  ...
  { code: "10 06 04", description: "autres fines et poussières" },
  {
    code: "10 06 06*",
    description: "déchets solides provenant de l'épuration des fumées",
  },
  ...
  { code: "10 06 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 07 01",
    description: "scories provenant de la production primaire et secondaire",
  },
  ...
  { code: "10 07 04", description: "autres fines et poussières" },
  {
    code: "10 07 05",
    description:
      "boues et gâteaux de filtration provenant de l'épuration des fumées",
  ...
  { code: "10 07 99", description: "déchets non spécifiés ailleurs" },
  { code: "10 08 04", description: "fines et poussières" },
  {
    code: "10 08 08*",
    description:
      "scories salées provenant de la production primaire et secondaire",
  },
  { code: "10 08 09", description: "autres scories" },
  {
    code: "10 08 10*",
    description:
      "crasses et écumes inflammables ou émettant, au contact de l'eau, des gaz inflammables en quantités dangereuses",
  ...
  { code: "10 08 14", description: "déchets d'anodes" },
  {
    code: "10 08 15*",
    description:
      "poussières de filtration des fumées contenant des substances dangereuses",
  ...
  { code: "10 08 99", description: "déchets non spécifiés ailleurs" },
  { code: "10 09 03", description: "laitiers de four de fonderie" },
  {
    code: "10 09 05*",
    description:
      "noyaux et moules de fonderie n'ayant pas subi la coulée contenant des substances dangereuses",
  ...
  {
    code: "10 09 13*",
    description: "déchets de liants contenant des substances dangereuses",
  },
  {
    code: "10 09 14",
    description:
  ...
  { code: "10 09 99", description: "déchets non spécifiés ailleurs" },
  { code: "10 10 03", description: "laitiers de four de fonderie" },
  {
    code: "10 10 05*",
    description:
      "noyaux et moules de fonderie n'ayant pas subi la coulée contenant des substances dangereuses",
  ...
  { code: "10 10 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 11 03",
    description: "déchets de matériaux à base de fibre de verre",
  },
  { code: "10 11 05", description: "fines et poussières" },
  {
    code: "10 11 09*",
    description:
      "déchets de préparation avant cuisson contenant des substances dangereuses",
  ...
  { code: "10 11 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 12 01",
    description: "déchets de préparation avant cuisson",
  },
  { code: "10 12 03", description: "fines et poussières" },
  {
    code: "10 12 05",
    description:
      "boues et gâteaux de filtration provenant de l'épuration des fumées",
  },
  { code: "10 12 06", description: "moules déclassés" },
  {
    code: "10 12 08",
    description:
      "déchets de produits en céramique, briques, carrelage et matériaux de construction (après cuisson)",
  ...
  { code: "10 12 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 13 01",
    description: "déchets de préparation avant cuisson",
  },
  ...
  {
    code: "10 13 06",
    description: "fines et poussières (sauf rubriques 10 13 12 et 10 13 13)",
  },
  {
    code: "10 13 07",
    description:
  ...
  { code: "10 13 14", description: "déchets et boues de béton" },
  { code: "10 13 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "10 14 01*",
    description:
      "déchets provenant de l'épuration des fumées contenant du mercure",
  },
  { code: "11 01 05*", description: "acides de décapage" },
  { code: "11 01 06*", description: "acides non spécifiés ailleurs" },
  { code: "11 01 07*", description: "bases de décapage" },
  { code: "11 01 08*", description: "boues de phosphatation" },
  {
    code: "11 01 09*",
    description:
      "boues et gâteaux de filtration contenant des substances dangereuses",
  ...
  {
    code: "11 01 13*",
    description: "déchets de dégraissage contenant des substances dangereuses",
  },
  {
    code: "11 01 14",
    description:
  ...
  { code: "11 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "11 02 02*",
    description:
      "boues provenant de l'hydrométallurgie du zinc (y compris jarosite et goethite)",
  ...
  { code: "11 02 99", description: "déchets non spécifiés ailleurs" },
  { code: "11 03 01*", description: "déchets cyanurés" },
  { code: "11 03 02*", description: "autres déchets" },
  { code: "11 05 01", description: "mattes" },
  { code: "11 05 02", description: "cendres de zinc" },
  {
    code: "11 05 03*",
    description: "déchets solides provenant de l'épuration des fumées",
  },
  { code: "11 05 04*", description: "flux utilisé" },
  { code: "11 05 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "12 01 01",
    description: "limaille et chutes de métaux ferreux",
  },
  ...
  {
    code: "12 01 05",
    description: "déchets de matières plastiques d'ébarbage et de tournage",
  },
  {
    code: "12 01 06*",
    description:
  ...
  {
    code: "12 01 08*",
    description: "émulsions et solutions d'usinage contenant des halogènes",
  },
  {
    code: "12 01 09*",
    description: "émulsions et solutions d'usinage sans halogènes",
  },
  { code: "12 01 10*", description: "huiles d'usinage de synthèse" },
  { code: "12 01 12*", description: "déchets de cires et graisses" },
  { code: "12 01 13", description: "déchets de soudure" },
  {
    code: "12 01 14*",
    description: "boues d'usinage contenant des substances dangereuses",
  },
  ...
  { code: "12 01 99", description: "déchets non spécifiés ailleurs" },
  { code: "12 03 01*", description: "liquides aqueux de nettoyage" },
  {
    code: "12 03 02*",
    description: "déchets du dégraissage à la vapeur",
  },
  ...
  { code: "13 01 13*", description: "autres huiles hydrauliques" },
  {
    code: "13 02 04*",
    description:
      "huiles moteur, de boîte de vitesses et de lubrification chlorées à base minérale",
  ...
  {
    code: "13 03 01*",
    description: "huiles isolantes et fluides caloporteurs contenant des PCB",
  },
  {
    code: "13 03 06*",
    description:
  ...
  {
    code: "13 03 08*",
    description: "huiles isolantes et fluides caloporteurs synthétiques",
  },
  {
    code: "13 03 09*",
    description:
  ...
  { code: "13 05 03*", description: "boues provenant de déshuileurs" },
  {
    code: "13 05 06*",
    description: "hydrocarbures provenant de séparateurs eau/hydrocarbures",
  },
  {
    code: "13 05 07*",
    description:
  ...
  { code: "13 07 01*", description: "fuel oil et diesel" },
  { code: "13 07 02*", description: "essence" },
  {
    code: "13 07 03*",
    description: "autres combustibles (y compris mélanges)",
  },
  { code: "13 08 01*", description: "boues ou émulsions de dessalage" },
  { code: "13 08 02*", description: "autres émulsions" },
  { code: "13 08 99*", description: "déchets non spécifiés ailleurs" },
  { code: "14 06 01*", description: "chlorofluorocarbones, HCFC, HFC" },
  {
    code: "14 06 02*",
    description: "autres solvants et mélanges de solvants halogénés",
  },
  ...
  {
    code: "14 06 04*",
    description: "boues ou déchets solides contenant des solvants halogénés",
  },
  {
    code: "14 06 05*",
    description: "boues ou déchets solides contenant d'autres solvants",
  },
  { code: "15 01 01", description: "emballages en papier/carton" },
  {
    code: "15 01 02",
    description: "emballages en matières plastiques",
  },
  { code: "15 01 03", description: "emballages en bois" },
  { code: "15 01 04", description: "emballages métalliques" },
  { code: "15 01 05", description: "emballages composites" },
  { code: "15 01 06", description: "emballages en mélange" },
  { code: "15 01 07", description: "emballages en verre" },
  { code: "15 01 09", description: "emballages textiles" },
  {
    code: "15 01 10*",
    description:
      "emballages contenant des résidus de substances dangereuses ou contaminés par de tels résidus",
  ...
  { code: "16 01 03", description: "pneus hors d'usage" },
  { code: "16 01 04*", description: "véhicules hors d'usage" },
  {
    code: "16 01 06",
    description:
      "véhicules hors d'usage ne contenant ni liquides ni autres composants dangereux",
  },
  { code: "16 01 07*", description: "filtres à huile" },
  { code: "16 01 08*", description: "composants contenant du mercure" },
  { code: "16 01 09*", description: "composants contenant des PCB" },
  {
    code: "16 01 10*",
    description:
      "composants explosifs (par exemple coussins gonflables de sécurité)",
  ...
  { code: "16 01 13*", description: "liquides de frein" },
  {
    code: "16 01 14*",
    description: "antigels contenant des substances dangereuses",
  },
  {
    code: "16 01 15",
    description: "antigels autres que ceux visés à la rubrique 16 01 14",
  },
  { code: "16 01 16", description: "réservoirs de gaz liquéfié" },
  { code: "16 01 17", description: "métaux ferreux" },
  { code: "16 01 18", description: "métaux non ferreux" },
  { code: "16 01 19", description: "matières plastiques" },
  { code: "16 01 20", description: "verre" },
  {
    code: "16 01 21*",
    description:
      "composants dangereux autres que ceux visés aux rubriques 16 01 07 à 16 01 11, 16 01 13 et 16 01 14",
  ...
  { code: "16 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "16 02 09*",
    description: "transformateurs et accumulateurs contenant des PCB",
  },
  ...
  {
    code: "16 02 15*",
    description: "composants dangereux retirés des équipements mis au rebut",
  },
  {
    code: "16 02 16",
    description:
  ...
  { code: "16 03 07*", description: "mercure métallique" },
  { code: "16 04 01*", description: "déchets de munitions" },
  { code: "16 04 02*", description: "déchets de feux d'artifice" },
  { code: "16 04 03*", description: "autres déchets d'explosifs" },
  {
    code: "16 05 04*",
    description:
      "gaz en récipients à pression (y compris les halons) contenant des substances dangereuses",
  ...
  { code: "16 06 01*", description: "accumulateurs au plomb" },
  { code: "16 06 02*", description: "accumulateurs Ni-Cd" },
  { code: "16 06 03*", description: "piles contenant du mercure" },
  {
    code: "16 06 04",
    description: "piles alcalines (sauf rubrique 16 06 03)",
  },
  { code: "16 06 05", description: "autres piles et accumulateurs" },
  {
    code: "16 06 06*",
    description: "électrolytes de piles et accumulateurs collectés séparément",
  },
  {
    code: "16 07 08*",
    description: "déchets contenant des hydrocarbures",
  ...
  { code: "16 07 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "16 08 01",
    description:
      "catalyseurs usés contenant de l'or, de l'argent, du rhénium, du rhodium, du palladium, de l'iridium ou du platine (sauf rubrique 16 08 07)",
  ...
  {
    code: "16 08 07*",
    description: "catalyseurs usés contaminés par des substances dangereuses",
  },
  {
    code: "16 09 01*",
    description: "permanganates, par exemple, permanganate de potassium",
  },
  {
    code: "16 09 02*",
    description:
  ...
  {
    code: "16 10 01*",
    description: "déchets liquides aqueux contenant des substances dangereuses",
  },
  {
    code: "16 10 02",
    description:
  ...
  {
    code: "16 10 03*",
    description: "concentrés aqueux contenant des substances dangereuses",
  },
  {
    code: "16 10 04",
    description:
  ...
  { code: "17 01 01", description: "béton" },
  { code: "17 01 02", description: "briques" },
  { code: "17 01 03", description: "tuiles et céramiques" },
  {
    code: "17 01 06*",
    description:
      "mélanges ou fractions séparées de béton, briques, tuiles et céramiques contenant des substances dangereuses",
  ...
  { code: "17 02 01", description: "bois" },
  { code: "17 02 02", description: "verre" },
  { code: "17 02 03", description: "matières plastiques" },
  {
    code: "17 02 04*",
    description:
      "bois, verre et matières plastiques contenant des substances dangereuses ou contaminés par de telles substances",
  ...
  { code: "17 03 03*", description: "goudron et produits goudronnés" },
  { code: "17 04 01", description: "cuivre, bronze, laiton" },
  { code: "17 04 02", description: "aluminium" },
  { code: "17 04 03", description: "plomb" },
  { code: "17 04 04", description: "zinc" },
  { code: "17 04 05", description: "fer et acier" },
  { code: "17 04 06", description: "étain" },
  { code: "17 04 07", description: "métaux en mélange" },
  {
    code: "17 04 09*",
    description:
      "déchets métalliques contaminés par des substances dangereuses",
  ...
  {
    code: "17 05 08",
    description: "ballast de voie autre que celui visé à la rubrique 17 05 07",
  },
  {
    code: "17 06 01*",
    description: "matériaux d'isolation contenant de l'amiante",
  ...
  {
    code: "18 01 09",
    description: "médicaments autres que ceux visés à la rubrique 18 01 08",
  },
  { code: "18 01 10*", description: "déchets d'amalgame dentaire" },
  {
    code: "18 02 01",
    description: "objets piquants et coupants (sauf rubrique 18 02 02)",
  },
  ...
  {
    code: "18 02 08",
    description: "médicaments autres que ceux visés à la rubrique 18 02 07",
  },
  {
    code: "19 01 02",
    description: "déchets de déferraillage des mâchefers",
  ...
  {
    code: "19 01 05*",
    description: "gâteaux de filtration provenant de l'épuration des fumées",
  },
  {
    code: "19 01 06*",
    description:
  ...
  {
    code: "19 01 10*",
    description: "charbon actif usé provenant de l'épuration des gaz de fumées",
  },
  {
    code: "19 01 11*",
    description: "mâchefers contenant des substances dangereuses",
  ...
  {
    code: "19 01 12",
    description: "mâchefers autres que ceux visés à la rubrique 19 01 11",
  },
  {
    code: "19 01 13*",
    description: "cendres volantes contenant des substances dangereuses",
  },
  {
    code: "19 01 14",
    description:
  ...
  {
    code: "19 01 15*",
    description: "cendres sous chaudière contenant des substances dangereuses",
  },
  {
    code: "19 01 16",
    description:
  ...
  {
    code: "19 01 17*",
    description: "déchets de pyrolyse contenant des substances dangereuses",
  },
  {
    code: "19 01 18",
    description:
  ...
  { code: "19 01 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "19 02 03",
    description:
      "déchets prémélangés composés seulement de déchets non dangereux",
  ...
  {
    code: "19 02 04*",
    description: "déchets prémélangés contenant au moins un déchet dangereux",
  },
  {
    code: "19 02 05*",
    description:
  ...
  {
    code: "19 02 07*",
    description: "hydrocarbures et concentrés provenant d'une séparation",
  },
  {
    code: "19 02 08*",
    description:
  ...
  { code: "19 02 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "19 03 04*",
    description:
      "déchets marqués comme dangereux partiellement stabilisés, autres que ceux visés à la rubrique 19 03 08",
  ...
  { code: "19 03 08*", description: "mercure partiellement stabilisé" },
  { code: "19 04 01", description: "déchets vitrifiés" },
  {
    code: "19 04 02*",
    description:
      "cendres volantes et autres déchets du traitement des gaz de fumée",
  },
  { code: "19 04 03*", description: "phase solide non vitrifiée" },
  {
    code: "19 04 04",
    description:
      "déchets liquides aqueux provenant de la trempe des déchets vitrifiés",
  ...
  {
    code: "19 05 01",
    description: "fraction non compostée des déchets municipaux et assimilés",
  },
  {
    code: "19 05 02",
    description: "fraction non compostée des déchets animaux et végétaux",
  },
  { code: "19 05 03", description: "compost déclassé" },
  { code: "19 05 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "19 06 03",
    description:
      "liqueurs provenant du traitement anaérobie des déchets municipaux",
  ...
  { code: "19 06 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "19 07 02*",
    description: "lixiviats de décharges contenant des substances dangereuses",
  },
  {
    code: "19 07 03",
    description:
  ...
  { code: "19 08 01", description: "déchets de dégrillage" },
  { code: "19 08 02", description: "déchets de dessablage" },
  {
    code: "19 08 05",
    description: "boues provenant du traitement des eaux usées urbaines",
  },
  {
    code: "19 08 06*",
    description: "résines échangeuses d'ions saturées ou usées",
  ...
  { code: "19 08 99", description: "déchets non spécifiés ailleurs" },
  {
    code: "19 09 01",
    description: "déchets solides de première filtration et de dégrillage",
  },
  { code: "19 09 02", description: "boues de clarification de l'eau" },
  { code: "19 09 03", description: "boues de décarbonatation" },
  { code: "19 09 04", description: "charbon actif usé" },
  {
    code: "19 09 05",
    description: "résines échangeuses d'ions saturées ou usées",
  },
  ...
  { code: "19 09 99", description: "déchets non spécifiés ailleurs" },
  { code: "19 10 01", description: "déchets de fer ou d'acier" },
  { code: "19 10 02", description: "déchets de métaux non ferreux" },
  {
    code: "19 10 03*",
    description:
      "fraction légère des résidus de broyage et poussières contenant des substances dangereuses",
  ...
  {
    code: "19 10 05*",
    description: "autres fractions contenant des substances dangereuses",
  },
  {
    code: "19 10 06",
    description:
  ...
  { code: "19 11 01*", description: "argiles de filtration usées" },
  { code: "19 11 02*", description: "goudrons acides" },
  { code: "19 11 03*", description: "déchets liquides aqueux" },
  {
    code: "19 11 04*",
    description:
      "déchets provenant du nettoyage d'hydrocarbures avec des bases",
  ...
  {
    code: "19 11 07*",
    description: "déchets provenant de l'épuration des gaz de combustion",
  },
  { code: "19 11 99", description: "déchets non spécifiés ailleurs" },
  { code: "19 12 01", description: "papier et carton" },
  { code: "19 12 02", description: "métaux ferreux" },
  { code: "19 12 03", description: "métaux non ferreux" },
  {
    code: "19 12 04",
    description: "matières plastiques et caoutchouc",
  },
  { code: "19 12 05", description: "verre" },
  {
    code: "19 12 06*",
    description: "bois contenant des substances dangereuses",
  },
  ...
  { code: "20 01 01", description: "papier et carton" },
  { code: "20 01 02", description: "verre" },
  {
    code: "20 01 08",
    description: "déchets de cuisine et de cantine biodégradables",
  },
  { code: "20 01 10", description: "vêtements" },
  { code: "20 01 11", description: "textiles" },
  { code: "20 01 13*", description: "solvants" },
  { code: "20 01 14*", description: "acides" },
  { code: "20 01 15*", description: "déchets basiques" },
  {
    code: "20 01 17*",
    description: "produits chimiques de la photographie",
  },
  ...
  {
    code: "20 01 21*",
    description: "tubes fluorescents et autres déchets contenant du mercure",
  },
  {
    code: "20 01 23*",
    description: "équipements mis au rebut contenant des chlorofluorocarbones",
  },
  {
    code: "20 01 25",
    description: "huiles et matières grasses alimentaires",
  ...
  {
    code: "20 01 30",
    description: "détergents autres que ceux visés à la rubrique 20 01 29",
  },
  {
    code: "20 01 31*",
    description: "médicaments cytotoxiques et cytostatiques",
  ...
  {
    code: "20 01 32",
    description: "médicaments autres que ceux visés à la rubrique 20 01 31",
  },
  {
    code: "20 01 33*",
    description:
  ...
  { code: "20 01 39", description: "matières plastiques" },
  { code: "20 01 40", description: "métaux" },
  {
    code: "20 01 41",
    description: "déchets provenant du ramonage de cheminée",
  },
  ...
  { code: "20 02 01", description: "déchets biodégradables" },
  { code: "20 02 02", description: "terres et pierres" },
  {
    code: "20 02 03",
    description: "autres déchets non biodégradables",
  },
  { code: "20 03 01", description: "déchets municipaux en mélange" },
  { code: "20 03 02", description: "déchets de marchés" },
  { code: "20 03 03", description: "déchets de nettoyage des rues" },
  { code: "20 03 04", description: "boues de fosses septiques" },
  {
    code: "20 03 06",
    description: "déchets provenant du nettoyage des égouts",
  },
  { code: "20 03 07", description: "déchets encombrants" },
  {
    code: "20 03 99",
    description: "déchets municipaux non spécifiés ailleurs",
  },
