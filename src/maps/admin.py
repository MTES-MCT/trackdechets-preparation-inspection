...
class RoleFilter(admin.SimpleListFilter):
    ...
    def queryset(self, request, queryset):
        ...
        # If no document type is selected or the field doesn't exist, use a generic role filter
...
class CartoCompanyAdmin(admin.ModelAdmin):
    ...
    # Add advanced search for the admin changelist
    ...
    # Add shorter action methods that build on the RoleFilter logic
