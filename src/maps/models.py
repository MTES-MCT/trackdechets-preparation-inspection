...
class CartoCompany(models.Model):
    ...
    # Bsdd
    bsdd = models.BooleanField(null=True, blank=True, db_index=True)
    ...
    # Bsdnd
    bsdnd = models.BooleanField(null=True, blank=True, db_index=True)
    ...
    # Bsff
    bsff = models.BooleanField(null=True, blank=True, db_index=True)
    ...
    # Bsdasri
    bsdasri = models.BooleanField(null=True, blank=True, db_index=True)
